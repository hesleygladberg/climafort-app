...
async def run_test():
    ...
    try:
        ...
        # -> Fill in the registration form with valid email and password.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        # Click on 'Criar Conta' button to submit the registration form
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Registration Successful! Welcome, new user!').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: The user registration did not complete successfully or the success message was not displayed as expected.")
